...
class SoftHoeffdingTreeLayer(nn.Module):
    ...
    def plot_tree(self, instance, tree_idx=0, save_img=False, text_format=False):
        ...
        # Return text format of tree
        if text_format:
            return self.sohot_visualization[tree_idx].get_tree_text(X=x_trans,
